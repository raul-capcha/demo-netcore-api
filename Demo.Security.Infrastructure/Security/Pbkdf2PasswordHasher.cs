...
namespace Demo.Security.Infrastructure.Security
{
    ...
    public sealed class Pbkdf2PasswordHasher : IPasswordHasher
    {
        ...
        private const string Hashkey = "PBKDF2-SHA256";  // 256-bit
        ...
        public string Hash(string plaintext)
        {
            ...
            return $"{Hashkey}${Iterations}${Convert.ToBase64String(salt)}${Convert.ToBase64String(key)}";
        }
        ...
        public bool Verify(string hash, string plaintext)
        {
            try
            {
                ...
                if (parts.Length != 4 || parts[0] != Hashkey) return false;
